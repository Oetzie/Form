...
$_lang['setting_form.use_pdotools']                             = 'Gebruik pdoTools';
$_lang['setting_form.use_pdotools_desc']                        = 'Indien ja en pdoTools is geinstalleerd, zullen de chunks geparsed worden door pdoTools. Standaard is "Nee".';
$_lang['setting_form.encrypt']                                  = 'Formulieren encryptie';
$_lang['setting_form.encrypt_desc']                             = 'Indien ja zullen de formulieren geëncrypt opgeslagen worden. Standaard is "Ja".';
$_lang['setting_form.encrypt_key']                              = 'Formulieren encryptie sleutel';
$_lang['setting_form.encrypt_key_desc']                         = 'De encryptie sleutel om de formulieren te decrypten indien de instelling "encryptie" op "Ja" ingesteld is.';
$_lang['setting_form.encrypt_method']                           = 'Formulieren encryptie methode';
$_lang['setting_form.encrypt_method_desc']                      = 'De encryptie methode om de formulieren te encrypten indien de instelling "encryptie" op "Ja" ingesteld is. Dit kan "mcrypt" of "openssl" zijn, standaard "openssl".';
...
$_lang['setting_form.media_source']                              = 'Formulieren media source';
$_lang['setting_form.media_source_desc']                         = 'De media source die gebruikt voor onderandere de e-mail attachments and uploads.';
